...
export const routes: Routes = [
...

    {
        ...
        children: [
            ...
            { path: 'admin/suppliers', loadComponent: () => import('./pages/admin/manage-suppliers/manage-suppliers.component').then(m => m.ManageSuppliersComponent), canActivate: [roleGuard(['ROLE_ADMIN'])] },
